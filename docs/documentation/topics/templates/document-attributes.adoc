...
:loggingguide_name: Logging Guide
:loggingguide_link: {server_guide_base_link}/logging
...
:securing_apps_jwt_authorization_grant_link: {securing_apps_base_link}/jwt-authorization-grant
