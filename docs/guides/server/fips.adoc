...
NOTE: {project_name} FIPS 140-2 integration is tested with OpenJDK 25. The underlying BouncyCastle
FIPS library may not yet be officially validated with OpenJDK 25; verify compliance requirements for your environment.
